...
public class Home extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new DrawerItem("Organizations", R.drawable.ic_action_group));
		 ...
		 dataList.add(new DrawerItem("Profile", R.drawable.ic_action_camera));
		 dataList.add(new DrawerItem("Search", R.drawable.ic_action_search));
		dataList.add(new DrawerItem("Badges", R.drawable.ic_action_labels));
		dataList.add(new DrawerItem("Feedbacks", R.drawable.ic_action_import_export));
